...
public class script extends IteratingVUserScript {
	...
	public void run() throws Exception {
		...
		forms.flexWindow("//forms:flexWindow").clickOk();
		forms.list("//forms:list[(@name='ASSET_CAP_ASSET_TYPE_0')]").selectItem("CIP");
		...
		forms.textField("//forms:textField[(@name='FA_BOOKS_COST_0')]").setText("0");
		...
		forms.flexWindow(141, "//forms:flexWindow").setText("Function", "",	"000");
		forms.flexWindow(142, "//forms:flexWindow").setText("Cost Center","", "100180");
		...
		String Assetnum=forms.choiceBox(185, "//forms:choiceBox").getAlertMessage();
		info(Assetnum);
