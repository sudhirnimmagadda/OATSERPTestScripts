...
public class script extends IteratingVUserScript {
	...
	public void run() throws Exception {
        ...
        {
        String OrgName=(String)datatable.getValue(i, "A");
        info(OrgName);
        String Altname=(String)datatable.getValue(i, "B");
        info(Altname);
        String Country=(String)datatable.getValue(i, "C");
        info(Country);
        String TaxPayID=(String)datatable.getValue(i, "D");
        info(TaxPayID);
        String Addline1=(String)datatable.getValue(i, "E");
        info(Addline1);
        String Addline2=(String)datatable.getValue(i, "F");
        info(Addline2);
        String City=(String)datatable.getValue(i, "G");
        info(City);
        String State=(String)datatable.getValue(i, "H");
        info(State);
        String Postalcode=(String)datatable.getValue(i, "I");
        info(Postalcode);
        String ADDName=(String)datatable.getValue(i, "J");
        info(ADDName);
        String AddPur=(String)datatable.getValue(i, "K");
        info(AddPur);
        String Phone=(String)datatable.getValue(1, "L");
        info(Phone);
        String EMailadd=(String)datatable.getValue(1, "M");
        info(EMailadd);
        String Crenumsite=(String)datatable.getValue(i, "N");
        info(Crenumsite);
        String CrtcntDir=(String)datatable.getValue(i, "O");
        info(CrtcntDir);
        String FrstName=(String)datatable.getValue(i, "P");
        info(FrstName);
        String Lstname=(String)datatable.getValue(i, "Q");
        info(Lstname);
        String Bankdtls=(String)datatable.getValue(i, "R");
        info(Bankdtls);
        String Crtbnk=(String)datatable.getValue(i, "S");
        info(Crtbnk);
        String Country1=(String)datatable.getValue(i, "T");
        info(Country1);
        String SelExtbnk=(String)datatable.getValue(i, "U");
        info(SelExtbnk);
        String BankNum=(String)datatable.getValue(i, "V");
        info(BankNum);
        String Accnum=(String)datatable.getValue(i, "W");
        info(Accnum);
        String AccName=(String)datatable.getValue(i, "X");
        info(AccName);
        String Currency=(String)datatable.getValue(i, "Y");
        info(Currency);
        String PayTerm=(String)datatable.getValue(i, "Z");
        info(PayTerm);
        String PayMeth=(String)datatable.getValue(i, "AA");
        info(PayMeth);
        String PayGroup=(String)datatable.getValue(i, "AB");
        info(PayGroup);
   ...
   //web.element("/web:window[@index='2' or @title='Create Supplier']/web:document[@index='0']/web:div[@text='Error' or @index='0']")
     ...
     if(errordata !=null){
	   ...
	   web.link("/web:window[@index='2' or @title='Create Supplier']/web:document[@index='0']/web:a[@text='Suppliers' or @index='6']").click();
	   break;
	...
	*/
	...
	//web.button("/web:window[@index='2' or @title='Bank Accounts']/web:document[@index='0' or @name='APPS_NAVIGATION']/web:form[@id='DefaultFormName' or @name='DefaultFormName' or @index='0']/web:button[@id='BAAddButton' or @index='3']")
					//.click();
                              							...
                              							///// selecting site level//// 
	web.selectBox("/web:window[@index='2' or @title='Bank Accounts']/web:document[@index='0']/web:form[@id='DefaultFormName' or @name='DefaultFormName' or @index='0']/web:select[(@id='usesList' or @name='usesList' or @index='0') and multiple mod 'False']").selectOptionByText("Site");
	think(15);
	web.image("/web:window[@index='2' or @title='Bank Accounts']/web:document[@index='0']/web:img[@alt='Search: sitesList' or @index='21' or @src='https://erpint.fin.yahoo.com:8000/OA_HTML/cabo/images/alta/func_search_16_ena.png']").click();
	...
	think(15);
	web.image("/web:window[@index='3' or @title='Search and Select List of Values']/web:document[@index='1']/web:img[@alt='Quick Select' or @index='4' or @src='https://erpint.fin.yahoo.com:8000/OA_HTML/cabo/images/cache/cqs.gif']").click();
	think(15);
	web.button("/web:window[@index='2' or @title='Bank Accounts']/web:document[@index='0']/web:form[@id='DefaultFormName' or @name='DefaultFormName' or @index='0']/web:button[@id='goButton' or @index='2']").click();
	think(15);
