...
public class script extends IteratingVUserScript {
	...
	public void run() throws Exception {
		...
		forms.textField("//forms:textField[(@name='INV_SUM_FOLDER_INVOICE_TYPE_0')]").setText("Debit Memo");
		...
		forms.textField("//forms:textField[(@name='INV_SUM_FOLDER_INVOICE_AMOUNT_DSP_0')]").setText("-10");
		...
		forms.textField("//forms:textField[(@name='LINE_SUM_FOLDER_AMOUNT_DISP_0')]").setText("-10");
		...
		forms.textField("//forms:textField[(@name='D_SUM_FOLDER_AMOUNT_0')]").setText("-10");
