...
public class script extends IteratingVUserScript {
	...
	public void run() throws Exception {
		...
		forms.textField("//forms:textField[(@name='INV_SUM_FOLDER_INVOICE_AMOUNT_DSP_0')]").setText("150");
		...
		forms.textField("//forms:textField[(@name='LINE_SUM_FOLDER_AMOUNT_DISP_0')]").setText("150");
		...
		forms.textField("//forms:textField[(@name='D_SUM_FOLDER_AMOUNT_0')]").setText("150");
		...
		else
		{
			...
			forms.textField("//forms:textField[(@name='PAY_SUM_FOLDER_PAYMENT_PROFILE_NAME_0')]").setText("OATS_PAYMENT_PROFILE");
			...
			forms.button("//forms:button[(@name='PAY_SUM_CONTROL_ACTIONS_0')]").click();
			think(10);
			...
			if (Acctstatus.equalsIgnoreCase("Processed")){
